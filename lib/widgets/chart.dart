...
//   Chart({required this.recentTransactins});
...
//       0.0,
//       (previousValue, element) => previousValue + double.parse(element['amount'].toString()),
//     );
//   }
...
//             return Flexible(
//                 fit: FlexFit.tight,
//                 child: ChartBar(e['day'].toString(), double.parse(e['amount'].toString()),
